...
JetAnalyzer::JetAnalyzer():verbosity_(0),useMC_(false),doBtagSF_(false)
{
}

JetAnalyzer::JetAnalyzer(int verbosity):verbosity_(verbosity),useMC_(false),doBtagSF_(false)
{
}
...
JetAnalyzer::JetAnalyzer(const edm::ParameterSet& myConfig, int verbosity):verbosity_(verbosity)
{
  ...
  doBtagSF_ = myConfig.getUntrackedParameter<bool>("doBtagSF");
}
