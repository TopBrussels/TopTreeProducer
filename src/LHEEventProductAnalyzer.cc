...
void LHEEventProductAnalyzer::PrintWeightNamesList(edm::Run const& iRun, edm::EventSetup const& iSetup) //To know which integer XXX corresponds to which weight
{
