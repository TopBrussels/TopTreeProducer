...
//		if(verbosity_>2) cout << "   ["<< setw(3) << j << "] " << ((TRootElectron*)rootElectrons->At(j))->isGsfCtfScPixConsistent() << endl;
//		if(verbosity_>2) cout << "   ["<< setw(3) << j << "] " << ((TRootElectron*)rootElectrons->At(j))->trackMomentum() << endl;
//		if(verbosity_>2) cout << "   ["<< setw(3) << j << "] " << ((TRootElectron*)rootElectrons->At(j))->fbrem() << endl;
//		if(verbosity_>2) cout << "   ["<< setw(3) << j << "] " << ((TRootElectron*)rootElectrons->At(j))->isFromConversion() << endl;
//		if(verbosity_>2) cout << "   ["<< setw(3) << j << "] " << electron->fbrem() << endl;
	}
} 
