...
public:
    ...
    void setEERingGap(bool is){isEERingGap_ = is;};
     ...
     Float_t ecalIso(unsigned int cone)const{
        if(cone == 1)
            return ecalRecHitSumEt01;
        else if(cone == 2)
            return ecalRecHitSumEt02;
        else if(cone == 3)
            return ecalRecHitSumEt03;
        else if(cone == 4)
            return ecalRecHitSumEt04;
        else if(cone == 5)
            return ecalRecHitSumEt05;
        else {
    ...
    Float_t hcalIso(unsigned int cone)const{
        if(cone == 1)
            return (hcalDepth1TowerSumEt01 + hcalDepth2TowerSumEt01);
        else if(cone == 2)
            return (hcalDepth1TowerSumEt02 + hcalDepth2TowerSumEt02);
        else if(cone == 3)
            return (hcalDepth1TowerSumEt03 + hcalDepth2TowerSumEt03);
        else if(cone == 4)
            return (hcalDepth1TowerSumEt04 + hcalDepth2TowerSumEt04);
        else if(cone == 5)
            return (hcalDepth1TowerSumEt05 + hcalDepth2TowerSumEt05);
        else {
            cout<<"Bad Cone Size! It returns -1."<<endl;
            return -1.;
        }
    ...
    Float_t hcalIso_Dept1(unsigned int cone)const{
        if(cone == 1)
            return (hcalDepth1TowerSumEt01 );
        else if(cone == 2)
            return (hcalDepth1TowerSumEt02);
        else if(cone == 3)
            return (hcalDepth1TowerSumEt03);
        else if(cone == 4)
            return (hcalDepth1TowerSumEt04 );
        else if(cone == 5)
            return (hcalDepth1TowerSumEt05 );
        else {
            cout<<"Bad Cone Size! It returns -1."<<endl;
            return -1.;
        }
    ...
    Float_t hcalIso_Dept2(unsigned int cone)const{
        if(cone == 1)
            return ( hcalDepth2TowerSumEt01);
        else if(cone == 2)
            return (hcalDepth2TowerSumEt02);
        else if(cone == 3)
            return ( hcalDepth2TowerSumEt03);
        else if(cone == 4)
            return ( hcalDepth2TowerSumEt04);
        else if(cone == 5)
            return (hcalDepth2TowerSumEt05);
        else {
            cout<<"Bad Cone Size! It returns -1."<<endl;
            return -1.;
        }
