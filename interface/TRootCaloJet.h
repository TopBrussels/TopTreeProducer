#ifndef TRootCaloJet_h
#define TRootCaloJet_h
...
namespace TopTree
{
	class TRootCaloJet : public TRootJet
	{
	...
	public:
		...
		TRootCaloJet(const TRootCaloJet& jet) :
			TRootJet(jet)
		...
		TRootCaloJet(const TRootJet& jet) :
			TRootJet(jet)
			,etaetaMoment_(-9999.)
			,phiphiMoment_(-9999.)
			,ecalEnergyFraction_(-9999.)
		...
		TRootCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e) :
			TRootJet(px,py,px,e)
			,etaetaMoment_(-9999.)
			,phiphiMoment_(-9999.)
			,ecalEnergyFraction_(-9999.)
		...
		TRootCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z) :
		...
		TRootCaloJet(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z, Int_t type, Float_t charge) :
		...
		TRootCaloJet(const TLorentzVector &momentum) :
			TRootJet(momentum)
			,etaetaMoment_(-9999.)
			,phiphiMoment_(-9999.)
			,ecalEnergyFraction_(-9999.)
		...
		TRootCaloJet(const TLorentzVector &momentum, const TVector3 &vertex, Int_t type, Float_t charge) :
		...
		virtual TString typeName() const { return "TRootCaloJet"; }
		...
		friend std::ostream& operator<< (std::ostream& stream, const TRootCaloJet& jet) {
			stream << "TRootCaloJet - Charge=" << setw(2) << jet.charge() << " (Et,eta,phi)=("<< setw(10) << jet.Et() <<","<< setw(10) << jet.Eta() <<","<< setw(10) << jet.Phi() << ")"
