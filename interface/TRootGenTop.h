...
class TRootGenTop : public TRootMCParticle {
 ...
 public:
  ...
  TRootGenTop():TRootMCParticle(), isHadronic_(false), isLeptonic_(false), W_ (TRootMCParticle()), bquark_ (TRootMCParticle()), 
  	quark_ (TRootMCParticle()), quarkBar_ (TRootMCParticle()), lepton_ (TRootMCParticle()), neutrino_ (TRootMCParticle()), production_ (string(""))
  {};
  TRootGenTop(const TRootMCParticle& top):TRootMCParticle(top), isHadronic_(false), isLeptonic_(false), W_ (TRootMCParticle()), bquark_ (TRootMCParticle()),
  	quark_ (TRootMCParticle()), quarkBar_ (TRootMCParticle()), lepton_ (TRootMCParticle()), neutrino_ (TRootMCParticle()), production_ (string(""))
  {};
