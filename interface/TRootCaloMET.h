#ifndef TRootCaloMET_h
#define TRootCaloMET_h
...
namespace TopTree
{
	class TRootCaloMET : public TRootMET
	{
	public:
		...
		TRootCaloMET(const TRootCaloMET& met) :
			TRootMET(met)
		  ...
		  TRootCaloMET(const TRootMET& met) :
			TRootMET(met)
			,maxEtInEmTowers_(-9999.)
			,maxEtInHadTowers_(-9999.)
			,hadEtInHO_(-9999.)
		...
		TRootCaloMET(Double_t px, Double_t py, Double_t pz, Double_t e) :
			TRootMET(px,py,pz,e)
			,maxEtInEmTowers_(-9999.)
			,maxEtInHadTowers_(-9999.)
			,hadEtInHO_(-9999.)
		...
		TRootCaloMET(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z) :
		...
		TRootCaloMET(Double_t px, Double_t py, Double_t pz, Double_t e, Double_t vtx_x, Double_t vtx_y, Double_t vtx_z, Int_t type, Float_t charge) :
		...
		TRootCaloMET(const TLorentzVector &momentum) :
			TRootMET(momentum)
			,maxEtInEmTowers_(-9999.)
			,maxEtInHadTowers_(-9999.)
			,hadEtInHO_(-9999.)
		...
		TRootCaloMET(const TLorentzVector &momentum, const TVector3 &vertex, Int_t type, Float_t charge) :
		...
		virtual TString typeName() const { return "TRootCaloMET"; }
		...
		friend std::ostream& operator<< (std::ostream& stream, const TRootCaloMET& met)
		{
			stream << "TRootCaloMET  (Pt,Px,Py)=("<< met.Pt() <<","<< met.Px() <<","<< met.Py() << ")"
