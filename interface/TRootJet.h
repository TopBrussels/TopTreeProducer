...
public:
	...
	TRootJet(const TRootJet& jet) :
		...
		,chargedEnergyFraction_(jet.chargedEnergyFraction_)
                ,maxEInEmTowers_(maxEInEmTowers_)
                ,maxEInHadTowers_(maxEInHadTowers_)
	        ,towersArea_(towersArea_) 
		,chargedBroadness_(jet.chargedBroadness_)
	        ,btag_combinedSecondaryVertexBJetTags_(btag_combinedSecondaryVertexBJetTags_)
	        ,btag_combinedSecondaryVertexMVABJetTags_(btag_combinedSecondaryVertexMVABJetTags_)
	        ,btag_impactParameterMVABJetTags_(btag_impactParameterMVABJetTags_)
	        ,btag_jetBProbabilityBJetTags_(btag_jetBProbabilityBJetTags_)
	        ,btag_jetProbabilityBJetTags_(btag_jetProbabilityBJetTags_)
	        ,btag_simpleSecondaryVertexBJetTags_(btag_simpleSecondaryVertexBJetTags_)
	        ,btag_softElectronBJetTags_(btag_softElectronBJetTags_)
	        ,btag_softMuonBJetTags_(btag_softMuonBJetTags_)
	        ,btag_softMuonNoIPBJetTags_(btag_softMuonNoIPBJetTags_)
	        ,btag_trackCountingHighEffBJetTags_(btag_trackCountingHighEffBJetTags_)
	        ,btag_trackCountingHighPurBJetTags_(btag_trackCountingHighPurBJetTags_)
